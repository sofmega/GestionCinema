...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("Casablanca","Marrakech","Rabat","Bejaad").forEach(nameVille->{
	...
	public void initCategorie() {
		Stream.of("Action","Fiction","Drama","Histoir").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("Iron man","Spider man","Cat woman","Batman")
		.forEach(titreFilm->{
			Film film=new Film();
